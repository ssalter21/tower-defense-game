...
namespace Sim
{
    ...
    /// </para>
    /// <para>
    /// <b>Nothing here is written to a file, and in here that is enforced rather
    /// than observed.</b> Text out, and whether it is fit to keep is a question for
    /// whoever proves it: a session's script is compared against a fresh run of
    ...
    /// </para>
    /// </remarks>
    public static class PlayedScript
    {
        /// <summary>
        ...
        /// <summary>
        /// What stands between the wave and the first slot: one space, which with
        /// <see cref="Gap"/> puts the first slot three columns after the wave.
        /// </summary>
