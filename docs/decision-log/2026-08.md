# The decision log — August 2026

One month of [the decision log](../decision-log.md): every time the vision changed its own mind, with what it
said, what is true now, and why it moved. The other month is [September 2026](2026-09.md). Entries run
...
[open one](2026-09.md#13-september-2026-after-the-map--the-vision-is-rebaselined-on-a-playtest-of-six-friends-and-five-claims-reverse) with what each
