...
| [`black-knight-beside-towers.png`](black-knight-beside-towers.png) | Wave 9's offence at 3×. The Black Knight stands beside four defence towers and is as tall as they are. This is the frame that settled it: an edit-mode test used to be red over exactly this, and on 6 September 2026 the rule was retired rather than the size changed — a creep may stand as tall as a tower, and a future boss may stand taller. See [`roster.md`](../../roster.md) and [#261](https://github.com/ssalter21/tower-defense-game/issues/261). |
