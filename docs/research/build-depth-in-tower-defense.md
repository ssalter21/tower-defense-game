...
[§11](../vision.md#11-out-of-scope). It gets no further consideration — except as evidence, because Ninja Kiwi's
...
|---|---|---|---|---|
| A1 | **Progressive disclosure by account unlock** | BTD6 gates towers behind account XP levels; Mazebert gates cards behind a collection | **Yes** | ☠️ **Dead** — [§4](../vision.md#4-what-persists), [§11](../vision.md#11-out-of-scope) |
...
[how wide the damage-type matrix should be](../vision.md#10-not-yet-specified) — because a six-element cycle at
...
[what a run is](../vision.md#10-not-yet-specified) still being open.
