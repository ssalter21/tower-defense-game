...
⚠️ Note for [the open damage-matrix question](../README.md#status): this is a **4:1 spread** (200% vs 50%), the
same figure [Part V §4.1](../variance-levers-and-unit-schema.md#41-the-scalar-layer--three-shapes-pick-exactly-one)
...
1. **The 4:1 damage spread has a fifteen-year track record**, not a one-patch one (§2.4). That strengthens one side
   of [the open damage-matrix question](../README.md#status).
