...
> **★ Corrected by [the build-depth research](https://github.com/ssalter21/tower-defense-game/blob/main/docs/research/build-depth-in-tower-defense.md#21-the-roster-is-combinatorially-complete--with-one-hole).**
