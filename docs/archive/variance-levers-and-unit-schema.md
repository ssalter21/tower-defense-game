...
> **★ Corrected by the build-depth research, [summarised in open questions](https://github.com/ssalter21/tower-defense-game/blob/main/docs/research/design-surveys-digest.md).**
